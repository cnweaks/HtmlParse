...
import com.cnweak.rebash.FileManageActivity;
import com.cnweak.rebash.R;

public class FileHandler {
    //工具类最好不要带有资源，因为要NEW很多，所以不能保证资源同步
    //以下变量是共有资源，还可以用synconised来同步
	public static File parentFile = new File("/");
	public  static long size = 0;
	public static int length = 0;

    //打开文件夹
	public  List openFile(File f) {
    ...
    void deleteFile(Context context, File f) {
        ...
        //遍历父目录刷新列表
        FileManageActivity activity = (FileManageActivity) context;
