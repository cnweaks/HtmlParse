...
import com.cnweak.rebash.filemanage.FindService;
import com.cnweak.rebash.filemanage.FileHandler;
import com.cnweak.rebash.filemanage.MyAdapter;
import com.cnweak.rebash.filemanage.MyAnimation;
...
public class FileManageActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = new Intent(FileManageActivity.this, FindService.class);
        startService(i);
    ...
    //加载 MyAdapter
	public  void loadAdapter(List<Map<String, Object>> list) {
        //传入key和layout_id，Adapter可以获得key关联的value
        String[] str = new String[]{"0", "1", "2"};
        int[] i = new int[]{R.id.iv, R.id.tv, R.id.tv1};
        //注意这里的构造函数被我重写了
        myAdapter = new MyAdapter(actvList, lv, this, list, R.layout.file_activity_adapter, str, i);
